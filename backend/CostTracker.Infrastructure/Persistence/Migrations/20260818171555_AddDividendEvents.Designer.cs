...
namespace CostTracker.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260818171555_AddDividendEvents")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CostTracker.Domain.Entities.DividendEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("FxProviderCode")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("fx_provider_code");

                    b.Property<decimal?>("GrossAmount")
                        .HasColumnType("numeric(24,12)")
                        .HasColumnName("gross_amount");

                    b.Property<decimal>("GrossAmountPerUnit")
                        .HasColumnType("numeric(24,12)")
                        .HasColumnName("gross_amount_per_unit");
                    ...
                    b.Property<decimal?>("NetAmountEur")
                        .HasColumnType("numeric(24,12)")
                        .HasColumnName("net_amount_eur");
                    ...
                    b.HasIndex("ProcessedAt", "PaymentDate");

                    b.HasIndex("InstrumentId", "ExDate", "PaymentDate");

                    b.ToTable("dividend_events", null, t =>
                        {
                            t.HasCheckConstraint("ck_dividend_events_amount_per_unit_positive", "gross_amount_per_unit > 0");

                            t.HasCheckConstraint("ck_dividend_events_amounts", "(gross_amount IS NULL OR gross_amount >= 0) AND (withholding_tax_amount IS NULL OR withholding_tax_amount >= 0) AND (net_amount IS NULL OR net_amount >= 0)");

                            t.HasCheckConstraint("ck_dividend_events_eligible_quantity", "eligible_quantity IS NULL OR eligible_quantity >= 0");

                            t.HasCheckConstraint("ck_dividend_events_payment_after_ex", "payment_date >= ex_date");

                            t.HasCheckConstraint("ck_dividend_events_tax_rate", "withholding_tax_rate >= 0 AND withholding_tax_rate < 1");
                        });
                });
